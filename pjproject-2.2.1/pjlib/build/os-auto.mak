...
#export TEST_LDFLAGS += -O2 -m32 -mios-simulator-version-min=5.0 -arch x86_64 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer//SDKs/iPhoneSimulator8.0.sdk -framework AudioToolbox -framework Foundation -L/Users/matias/workspace/ios-pjsip/pjproject-2.2.1/../silk-arm-ios -lm -lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit -framework UIKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -lSKP_SILK_SDK
