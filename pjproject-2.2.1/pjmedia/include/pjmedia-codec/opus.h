 ...
 */
#ifndef __PJMEDIA_OPUS_H__
#define __PJMEDIA_OPUS_H__
...
/**
 * @defgroup PJMED_OPUS OPUS
 * @ingroup PJMEDIA_CODEC
 * @brief Standard OPUS codec.
 * @{
...
/**
 * Unregister OPUS codec factory from pjmedia endpoint.
 *
 * @return	    PJ_SUCCESS on success.
 */
